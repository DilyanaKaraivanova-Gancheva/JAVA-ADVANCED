...
public class FilterStudentsByPhone {
    public static void main(String[] args) {
        ...
        List<Student> filtered = students.stream().filter(s-> s.getPhone().startsWith("02") || s.getPhone().startsWith("+3592"))
                .collect(Collectors.toList());

        for (Student student : filtered) {
            System.out.println(student.firstName + " " + student.lastName + " " + student.phone);
        }
    }
}
